...
public class RegisterApplicationController {
    ...
    public void completeRegistrationNutritionist(NutritionistBean nutritionistBean) {
        Nutritionist nutritionist = new Nutritionist (nutritionistBean.getEmail(),nutritionistBean.getName(),nutritionistBean.getSurname(), nutritionistBean.getDescription(), nutritionistBean.getDateOfBirth(),nutritionistBean.getIBAN(),nutritionistBean.getCost());
        NutritionistDao nutritionistDAO = new NutritionistDao();
