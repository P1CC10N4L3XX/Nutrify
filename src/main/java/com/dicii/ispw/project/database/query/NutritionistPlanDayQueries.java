...
public class NutritionistPlanDayQueries {
    ...
    public static boolean insertNutritionalPlanDay(Statement statement, NutritionalPlanDay nutritionalPlanDay ,Nutritionist nutritionist, Patient patient, Recipe recipe) throws SQLException {
        String query = String.format("INSERT INTO mydb.partecipazione (Nutrizionista,Paziente, RicettaColazione, RicettaPranzo, RicettaCena, QuantitaColazione ,QuantitaPranzo,QuantitaCena,DataConsumazione) values('%s','%s','%s','%s','%s','%s','%s','%s','%s')",
